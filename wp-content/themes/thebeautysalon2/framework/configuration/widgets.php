...
class eb_widget_search extends WP_Widget {
	...
	function widget( $args, $instance ) {
		ob_start();
		$style['background_color'] = 'background-color: ' . $instance['background_color'];
		$style['border_color'] = 'border-color: ' . $instance['border_color'];
		$style = implode( ';', $style );
		...
		<div class='widget-container eb_widget_search' id='<?php echo $args['widget_id'] ?>'>
			...
			<div class='widget-content'>
				<form style='<?php echo $style ?>' method="get" action="<?php echo home_url() ?>" _lpchecked="1">
					...
					<input placeholder='<?php echo $instance['placeholder'] ?>' type="text" name="s">
